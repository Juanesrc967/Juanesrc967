...
![header](https://capsule-render.vercel.app/api?type=waving&color=0:0D1117,50:161B22,100:6C63FF&height=200&section=header&text=Juan%20Esteban%20RC&fontSize=42&fontColor=FFFFFF&animation=fadeIn&fontAlignY=32&desc=Full%20Stack%20Developer%20•%20Tech%20Lead&descSize=16&descAlignY=52)

<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&duration=3000&pause=1000&color=6C63FF&center=true&vCenter=true&width=500&lines=Arquitecto+de+soluciones+digitales+%F0%9F%9A%80;Clean+Code+%7C+SOLID+%7C+Design+Patterns+%F0%9F%8E%AF;Liderando+equipos+de+alto+rendimiento+%F0%9F%92%A1" alt="Typing SVG" /></a>

</div>

---

<img align="right" src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcjF2OWI4YnBjMXlwdGRsMnQ5NXB0OXJrNjJ3OHR4cWp0YXRzYjZrNCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/qgQUggAC3Pfv687qPC/giphy.gif" width="300" />

### 🧑‍💻 &nbsp;Sobre Mí

```yaml
nombre: Juan Esteban RC
rol: Full Stack Developer & Tech Lead
ubicación: Colombia 🇨🇴
educación: Tecnólogo en Análisis y Desarrollo de Software
           Ing. Sistemas (en curso)
```

- 🔭 &nbsp;Construyendo **soluciones empresariales escalables**
- 🌱 &nbsp;Profundizando en **microservicios & arquitectura cloud**
- 👨‍💼 &nbsp;Liderando equipos hacia **las mejores prácticas**
- 🎯 &nbsp;Enfocado en **clean code y patrones de diseño**
...
> *"El código limpio no se escribe siguiendo reglas. Se aprende trabajando duro y fallando."* — **Robert C. Martin**

⭐ **Si te gusta mi trabajo, sígueme y dale estrella a mis repos** ⭐

![footer](https://capsule-render.vercel.app/api?type=waving&color=0:0D1117,50:161B22,100:6C63FF&height=100&section=footer)
